...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex w-[74.02px] h-[2.125rem] items-center justify-center rounded-xl border-2 bg-white p-3",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background "
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between ">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Boxer ref={div4Ref} className="h-36 w-64">
            <Icons.openai />
          </Boxer>
          <Boxer ref={div6Ref}>
            <Icons.zapier />
